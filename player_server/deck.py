...
Deck.append( Game_Card(1936, "Spanish Civil War breaks out", 53) )
Deck.append( Game_Card(1937, "Guernica by Picasso", 54) )
Deck.append( Game_Card(1908, "First Model-T car produced by Ford", 55) )
Deck.append( Game_Card(1928, "Agriculture collectivized in USSR", 56) )
Deck.append( Game_Card(1932, "Iraq becomes an independent country", 57) )
Deck.append( Game_Card(1941, "Britain and US sign the Atlantic Charter", 58) )
